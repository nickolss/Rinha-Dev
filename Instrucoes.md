...
• Para participar é necessário fazer um Pull Request

• A data de entrega é do dia 20/11/23 até 23:59

**IMPORTANTE**
Você terá 1.5 CPUs e 3.0GB para distribuir como quiser entre seus contêineres! Os limites mostrados aqui são apenas um exemplo – use-os como quiser. Aprender a lidar com restrições é muito importante!
...
### Database
Como já mencionado no início do documento, você poderá optar por usar Postgres, MySQL, ou MongoDB. 
...
### Imagens Docker
Você notou que o arquivo `docker-compose.yml` aponta para imagens da API que irá desenvolver, então é necessário que estas imagens estejam disponíveis publicamente em algum serviço como o [docker hub](https://hub.docker.com/). Caso contrário, o projeto será retornado para correção.
...
<a href='https://github.com/zanfranceschi/rinha-de-backend-2023-q3/blob/main/INSTRUCOES.md'>Repositório Original / Créditos</a>